    ...
    <section className="w-full bg-lightpink px-6 py-20">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="flex flex-col gap-8 lg:w-1/2">
          ...
          {/* DESCRIPTION */}
          <p className="text-base sm:text-lg text-rusty font-source font-bold leading-relaxed max-w-xl">
          ...
          {/* HIGHLIGHT TEXT */}
          <div>
            <p className="font-source font-bold text-dirtygold text-xl">
              Want to get to know me more?
            </p>
            <p className="font-source text-dirtygold font-bold text-xl">
